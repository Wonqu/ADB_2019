CREATE INDEX index_bids_bidtime ON bids USING btree (extract(YEAR FROM bid_time));
CREATE INDEX hash_index_bids_bidtime ON bids USING hash (bid_time);
CREATE INDEX brin_index_bids_bidtime ON bids USING brin (bid_time);
CREATE INDEX index_bids_bidstatus ON bids USING gin (bid_status);

DROP EXTENSION IF EXISTS btree_gin;
DROP INDEX IF EXISTS index_bids_bidtime;
DROP INDEX IF EXISTS hash_index_bids_bidtime;
DROP INDEX IF EXISTS brin_index_bids_bidtime;
DROP INDEX IF EXISTS index_bids_bidstatus;
